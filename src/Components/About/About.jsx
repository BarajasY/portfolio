            ...
            <motion.div className="about_content">
                <div className="about_wrapper">
                    <div className="about_text">
                        <motion.h1 initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }}>Hello, my name is Yahir Moreno Barajas, a mexican web developer and software engineering university student, and you're currently looking at my portfolio!</motion.h1>
                        <motion.h1 initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1 }}>It all started a while ago when i wanted to learn Python, at that time i had in mind to become a data scientist, i even learned Pandas/Seaborn/Jpt notebooks...</motion.h1>
