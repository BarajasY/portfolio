...
import { SiFirebase, SiBootstrap, SiReact, SiTypescript, SiExpress, SiPostgresql, SiGithub, SiVisualstudiocode, SiJava, SiSpring } from 'react-icons/si';
            ...
            <div className="stack_content">
                <div className="used_tech">
                    ...
                    <div className="wrapper">
                        ...
                        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: .5, delay: .1 }} viewport={{ once: true }}>
                            <SiSpring className="stack_icon"/>
                        </motion.div>
                        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: .5, delay: .1 }} viewport={{ once: true }}>
                            <SiJava className="stack_icon"/>
                        </motion.div>
                    </div>
                </div>
            </div>
