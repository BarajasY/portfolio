    ...
    return (
        <div className="test_project">
            ...
            <div className="buttons">
                ...
                <a href="https://github.com/Kanomb/astrobuyer" target="_blank" rel="noreferrer"><button className="page_buttons" style={{ borderRadius: '0px 40px 0px 0px' }}>Code</button></a>
            </div>
        </div>
    )
}
